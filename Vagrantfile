...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "adamdaigian-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/elasticbox_adam"
  #   chef.validation_client_name = "elasticbox_adam-validator"
  #   chef.validation_key_path = ".chef/elasticbox_adam-validator.pem"
  # end
end
